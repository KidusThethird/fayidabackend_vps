module.exports = {
  ...
  handleClubCallback: (bot, chatId, callbackData) => {
    if (callbackData === "grade_9_club") {
      ...
      bot.sendMessage(chatId, "Redirecting to Grade 10 Club...", {
        reply_markup: {
          inline_keyboard: [
            [
              {
                text: "Join Grade 10 Club",
                url: "https://t.me/fayidaacademy_grade10_club",
              },
            ],
          ],
        },
      ...
      bot.sendMessage(chatId, "Redirecting to Grade 11 Club...", {
        reply_markup: {
          inline_keyboard: [
            [
              {
                text: "Join Grade 11 Club",
                url: "https://t.me/fayidaacademy_grade11_club",
              },
            ],
          ],
        },
      ...
      bot.sendMessage(chatId, "Redirecting to Grade 12 Club...", {
        reply_markup: {
          inline_keyboard: [
            [
              {
                text: "Join Grade 12 Club",
                url: "https://t.me/fayidaacademy_grade12_club",
              },
            ],
          ],
        },

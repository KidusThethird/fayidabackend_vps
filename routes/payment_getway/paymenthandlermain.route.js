...
console.log("Id gen: "+generatedid)
  ...
  console.log("Amount recived: "+amount , "Reason: "+paymentReason + "merchantId: "+ GATEWAY_MERCHANT_ID + "Time: "+time)
    const payload = {
      amount,
    ...
    console.log("Returned Signed Token: "+jwt.sign(payload, PRIVATE_KEY_IN_PEM, { algorithm: 'ES256' }) )
        ...
        const amount = req.body.price;
          ...
          try {
            ...
            const postData = async () => {
                ...
                const url = 'https://services.santimpay.com/api/v1/gateway/initiate-payment'; // Replace with your API endpoint
                const payload = {
                ...
                try {
                    console.log("I have reached to post the payload: SignedTOken: "+generateSignedToken(1 , description)+" and RandomId: "+generateRandomId(req.user.id , req.body.packageId))
